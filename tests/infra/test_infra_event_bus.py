...
class TestEventBus:
    ...
    async def test_handler_receives_event_content(self) -> None:
        ...
        assert received_data is model_instance, (
            "Handler did not receive correct DataModel instance"
        )
    ...
    async def test_multiple_handlers_receive_correct_data(self) -> None:
        ...
        assert all(r is model_instance for r in received), (
            "Handlers did not receive correct event instance"
        )
